...
import java.util.*;
public class DisableHODFacultyList extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			ResultSet rs1=st.executeQuery("Select * from Users where (uRole='HOD' or uRole='StudentSectionFaculty') and uStatus='DISABLE'");
			...
			while(rs1.next())
			{
				pw.println("<tr><td><a href=\"EnableHODFaculty\"><font size=4>"+rs1.getString("uName")+"</font></a></td><td><font size=4>"+rs1.getString("uDept")+"</font></td><td><font size=4>"+rs1.getString("uRole")+"</font></td><td><a href=\"EnableHODFaculty?uid="+rs1.getInt("uid")+"\"><font size=4>Enable</font></a></td></tr>");
			}
