...
import java.util.*;
public class ShowHODList extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			"<table border=\"1\"><tr><th><font size=4>HOD Name</font></th><th><font size=4>Department Name</font></th></tr></center>");
			while(rs1.next())
			{
			...
			pw.println("</table><br><a href=\"ADMINTask.html\"><font size=4>BACK</font></a></body></html>");
		}
		catch(Exception ex)
		{
