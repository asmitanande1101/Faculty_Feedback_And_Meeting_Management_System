...
import java.util.*;
public class ShowFeedBackInShortSSFaculty extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res)
	{
		...
		/*	pw.println("<tr><td>6</td><td>Use of teaching aids</td><td>"+
			...
			pw.println("</table><center><a href=\"SSFacultyTask.html\"><font size=4>Back</font></a></center></body></html>");
		}
		catch(Exception ex)
		{
