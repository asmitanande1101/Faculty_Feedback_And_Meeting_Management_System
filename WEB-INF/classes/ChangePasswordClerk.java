...
import java.util.*;
public class ChangePasswordClerk extends HttpServlet
{
	public void doPost(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			if(pass.equals(cPass))
			{
				...
				{
					st.execute(q);
					RequestDispatcher rd=req.getRequestDispatcher("ClerkPasswordChanged.html");
					rd.forward(req,res);	
				}
				else
				{
					RequestDispatcher rd=req.getRequestDispatcher("ClerkWrongPasswordCP.html");
					rd.forward(req,res);
				}	
			}
			else
