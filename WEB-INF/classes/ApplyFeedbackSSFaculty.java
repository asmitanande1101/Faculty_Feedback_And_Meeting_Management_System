...
import java.util.*;
public class ApplyFeedbackSSFaculty extends HttpServlet
{
	public void doPost(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			String Q2=req.getParameter("rdoInteraction");
			String Q3=req.getParameter("rdoDAttitude");
			//String Q6=req.getParameter("rdoAids");
			String Q4=req.getParameter("rdoDiscipline");
			String Q5=req.getParameter("rdoOPerformance");
		...
		//	String sid=(String)ses.getAttribute("subId");
			...
			String str="insert into Feedback (fSenderId,fReceiver,Punctuality,Interaction,DAttitude,Discipline,OPerformance,fDate,fTime) values("+id+","+tid+",'"+Q1+"','"+Q2+"','"+Q3+"','"+Q4+"','"+Q5+"',now(),now())";
