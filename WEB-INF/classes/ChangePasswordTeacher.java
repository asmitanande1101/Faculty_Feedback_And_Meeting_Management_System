...
import java.util.*;
public class ChangePasswordTeacher extends HttpServlet
{
	public void doPost(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			if(pass.equals(cPass))
			{
				...
				{
					st.execute(q);
					RequestDispatcher rd=req.getRequestDispatcher("TeacherPasswordChanged.html");
					rd.forward(req,res);	
				}
				else
				{
					RequestDispatcher rd=req.getRequestDispatcher("TeacherWrongPasswordCP.html");
					rd.forward(req,res);
				}	
			}
			else
