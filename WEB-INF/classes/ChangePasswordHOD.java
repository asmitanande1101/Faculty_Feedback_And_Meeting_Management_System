...
import java.util.*;
public class ChangePasswordHOD extends HttpServlet
{
	public void doPost(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			if(pass.equals(cPass))
			{
				...
				{
					st.execute(q);
					RequestDispatcher rd=req.getRequestDispatcher("HODPasswordChanged.html");
					rd.forward(req,res);	
				}
				else
				{
					RequestDispatcher rd=req.getRequestDispatcher("HODWrongPasswordCP.html");
					rd.forward(req,res);
				}	
			}
			else
