...
import java.util.*;
public class ViewTeacherClerkList extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res)
	{
		try
		{
			...
			ResultSet rs1=st.executeQuery("Select * from Users where (uRole='TEACHER' or uRole='CLERK') and uDept='"+udept+"'");
			...
			while(rs1.next())
			{
				pw.println("<tr><td><a href=\"ViewTeacherClerk\"><font size=4>"+rs1.getString("uName")+"</font></a></td><td><font size=4>"+rs1.getString("uDept")+"</font></td><td><a href=\"ViewTeacherClerk?uid="+rs1.getInt("uid")+"\"><font size=4>View</font></a></td></tr>");
			}
